...
namespace GodsEye.TestPDF
{
    ...
    public class ReportDocument<T> : IDocument
    {
        private string ReportTitle { get; set; } = String.Empty;
        ...
        public ReportDocument(string reportTitle, List<T> data)
        {
